...
- [Day 01 - 【Day 1】學習 AI 之前我們需要準備什麼?](#day-01)
- [Day 02 - 【Day 2】人工智慧? 機器學習? 深度學習? 他們的差異在哪呢?](#day-02)
- [Day 03 - 【Day 3】使用單層感知器學習AI基礎數學](#day-03)
- [Day 04 - 【Day 4】用Numpy實作完整的模型訓練過程-用單層感知器解邏輯閘問題](#day-04)
- [Day 05 - 【Day 5】單層感知器為何無法解決XOR問題-多層感知器介紹與數學證明](#day-05)
- [Day 06 - 【Day 6】用Numpy實作完整的模型訓練過程2-用多層感知器解XOR邏輯閘問題](#day-06)
- [Day 07 - 【Day 7】深度神經網路與多層感知器的差異解析及PyTorch安裝指南](#day-07)
- [Day 08 - 【Day 8】使用Pytorch實現深度神經網絡進行MNIST手寫數字辨識](#day-08)
- [Day 09 - 【Day 9】辨識圖像的神工利器-卷機神經網路數學證明](#day-09)
- [Day 10 - 【Day 10】用卷積神經網路解CIFAR10影像辨識 - 建立一套屬於自己優化方式的訓練器](#day-10)
- [Day 11 - 【Day 10】用卷積神經網路解CIFAR10影像辨識 - 如何建立一個通識化神經網路](#day-11)
- [Day 12 - 【Day 12】在深度學習中電腦是如何辨識文字資料的](#day-12)
- [Day 13 - 【Day 13】探索文字與時間依賴關係-時間序列模型介紹與數學推導](#day-13)
- [Day 14 - 【Day 14】用LSTM解IMDB情緒分析- 排成器的使用與空白分詞](#day-14)
- [Day 15 - 【Day 15】圖片生成的老前輩-DCGAN介紹與數學推導](#day-15)
- [Day 16 - 【Day 16】用DCGAN生成假的MNIST手寫辨識集](#day-16)
- [Day 17 - 【Day 17】文字生成的老前輩-Seq2Seq介紹與數學推導](#day-17)
- [Day 18 - 【Day 18】Seq2Seq中的上下文向量為何無法很好的傳遞訊息-Attention介紹與數學推導](#day-18)
- [Day 19 - 【Day 19】用Seq2Seq+Attention進行文字翻譯](#day-19)
- [Day 20 - 【Day 20】主宰的AI世界強大模型架構-Transformer數學證明](#day-20)
- [Day 21 - 【Day 21】用Transformer來進行文本摘要](#day-21)
- [Day 22 - 【Day 22】何謂遷移式學習? 預訓練模型又是什麼?](#day-22)
- [Day 23 - 【Day 23】BERT的出現雙向Transformer模型的崛起與強大預訓練策略](#day-23)
- [Day 24 - 【Day 24】用BERT再次進行IMDB情緒分析](#day-24)
- [Day 25 - 【Day 25】Decoder Transformer的模型演進 - 從GPT-1到GPT-3的技術突破介紹](#day-25)
- [Day 26 - 【Day 26】用GPT-2解squad_v2問答資料集 - Prompting Learning與遮蔽策略的調整](#day-26)
- [Day 27 - 【Day 27】大型語言模型的常用技巧Instruction Learning 與 COT Few-Shot 技術解析](#day-27)
- [Day 28 - 【Day 28】Meta大規模語言模型 LLaMA 介紹：LLaMA 系列的歷史與數學推導](#day-28)
- [Day 29 - 【Day 29】探索大型語言模型的高效微調方式與優化技巧：QLoRA 和 NEFTune](#day-29)
- [Day 30 - 【Day 30】用LLaMA 3訓練屬於你的鄉民風格聊天機器人 - 從資料轉換到微調的完整教學](#day-30)
---
